package com.codecampus.quiz.configuration.redis;

import com.codecampus.quiz.grpc.LoadQuizResponse;
import com.codecampus.quiz.serialization.ProtoRedisSerializer;
...
public class RedisConfig {
    ...
    @Bean
    public RedisTemplate<String, LoadQuizResponse> loadQuizRedisTemplate(
