        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ColumnEffect = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrganizationMembers_Organizations_ScopeId",
                        column: x => x.ScopeId,
                        principalTable: "Organizations",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudentCredentials_Classes_ClassId",
                        column: x => x.ClassId,
                        principalTable: "Classes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentCredentials_Organizations_OrganizationId",
                        column: x => x.OrganizationId,
                        principalTable: "Organizations",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrganizationMembers_ScopeId",
                table: "OrganizationMembers",
                column: "ScopeId");

            migrationBuilder.CreateIndex(
                name: "IX_OrganizationMembers_UserId_ScopeType_ScopeId",
                table: "OrganizationMembers",
                columns: new[] { "UserId", "ScopeType", "ScopeId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_StudentCredentials_ClassId",
                table: "StudentCredentials",
                column: "ClassId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentCredentials_OrganizationId",
                table: "StudentCredentials",
                column: "OrganizationId");
        }
