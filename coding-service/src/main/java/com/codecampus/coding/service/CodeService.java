...
public class CodeService {
    ...
    public SubmissionResponseDto compileCode(SubmissionRequestDto submission)
        ...
        String containerName = STR."judge_\{submission.submissionId()}";

        Optional<CodingExercise> codingExerciseOpt =
                codingExerciseRepository.findById(submission.exerciseId());
        ...
        try {
            ...
            String overallMessage = hasWrongAnswer ? "Some test cases failed." :
