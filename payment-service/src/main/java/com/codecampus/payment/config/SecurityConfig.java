package com.codecampus.payment.config;

import static com.codecampus.payment.constant.config.SecurityConfigConstant.ACCEPT_HEADER;
import static com.codecampus.payment.constant.config.SecurityConfigConstant.AUTHORIZATION_HEADER;
import static com.codecampus.payment.constant.config.SecurityConfigConstant.CONTENT_TYPE_HEADER;
import static com.codecampus.payment.constant.config.SecurityConfigConstant.DELETE_METHOD;
import static com.codecampus.payment.constant.config.SecurityConfigConstant.FRONTEND_ENDPOINT;
import static com.codecampus.payment.constant.config.SecurityConfigConstant.FRONTEND_ENDPOINT2;
import static com.codecampus.payment.constant.config.SecurityConfigConstant.FRONTEND_ENDPOINT3;
import static com.codecampus.payment.constant.config.SecurityConfigConstant.GET_METHOD;
import static com.codecampus.payment.constant.config.SecurityConfigConstant.OPTIONS_METHOD;
import static com.codecampus.payment.constant.config.SecurityConfigConstant.PATCH_METHOD;
import static com.codecampus.payment.constant.config.SecurityConfigConstant.POST_METHOD;
import static com.codecampus.payment.constant.config.SecurityConfigConstant.PUBLIC_ENDPOINTS;
import static com.codecampus.payment.constant.config.SecurityConfigConstant.PUT_METHOD;
import static com.codecampus.payment.constant.config.SecurityConfigConstant.URL_PATTERN_ALL;
