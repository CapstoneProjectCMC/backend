...
import static com.codecampus.chat.constant.config.SecurityConfigConstant.ACCEPT_HEADER;
import static com.codecampus.chat.constant.config.SecurityConfigConstant.AUTHORIZATION_HEADER;
import static com.codecampus.chat.constant.config.SecurityConfigConstant.CONTENT_TYPE_HEADER;
import static com.codecampus.chat.constant.config.SecurityConfigConstant.DELETE_METHOD;
import static com.codecampus.chat.constant.config.SecurityConfigConstant.FRONTEND_ENDPOINT;
import static com.codecampus.chat.constant.config.SecurityConfigConstant.FRONTEND_ENDPOINT2;
import static com.codecampus.chat.constant.config.SecurityConfigConstant.FRONTEND_ENDPOINT3;
import static com.codecampus.chat.constant.config.SecurityConfigConstant.GET_METHOD;
import static com.codecampus.chat.constant.config.SecurityConfigConstant.OPTIONS_METHOD;
import static com.codecampus.chat.constant.config.SecurityConfigConstant.PATCH_METHOD;
import static com.codecampus.chat.constant.config.SecurityConfigConstant.POST_METHOD;
import static com.codecampus.chat.constant.config.SecurityConfigConstant.PUBLIC_ENDPOINTS;
import static com.codecampus.chat.constant.config.SecurityConfigConstant.PUT_METHOD;
import static com.codecampus.chat.constant.config.SecurityConfigConstant.URL_PATTERN_ALL;
