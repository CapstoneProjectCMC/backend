...
public interface SubmitQuizRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:quiz.SubmitQuizRequest)
   ...
   */
  java.util.List<com.codecampus.quiz.grpc.AnswerDto> 
      getAnswersList();
  /**
   * <code>repeated .quiz.AnswerDto answers = 3;</code>
   */
  com.codecampus.quiz.grpc.AnswerDto getAnswers(int index);
  /**
   * <code>repeated .quiz.AnswerDto answers = 3;</code>
   */
  int getAnswersCount();
   ...
   * <code>repeated .quiz.AnswerDto answers = 3;</code>
   */
  java.util.List<? extends com.codecampus.quiz.grpc.AnswerDtoOrBuilder> 
