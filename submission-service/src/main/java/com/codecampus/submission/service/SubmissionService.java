...
//
//    quizGrpcClient.sendSubmitQuiz(
//        GrpcQuizHelper.toQuizSubmitProto(
//            submission, submissionAnswerRepository.findBySubmission(submission)
//        )
//    );
//
//    applicationEventPublisher.publishEvent(
//        new QuizSubmittedEvent(submission, answers));
//
