...
import static com.codecampus.ai.constant.config.SecurityConfigConstant.ACCEPT_HEADER;
...
import static com.codecampus.ai.constant.config.SecurityConfigConstant.POST_METHOD;
import static com.codecampus.ai.constant.config.SecurityConfigConstant.PUBLIC_ENDPOINTS;
import static com.codecampus.ai.constant.config.SecurityConfigConstant.PUT_METHOD;
import static com.codecampus.ai.constant.config.SecurityConfigConstant.URL_PATTERN_ALL;
...
/**
 * Cấu hình bảo mật cho ai Service sử dụng Spring Security.
 *
 * <p>Bao gồm:
 * <ul>
