...
public class ResourceController {
    ...
    @PostMapping("/resource/{fileId}/save")
    ApiResponse<Void> saveResource(@PathVariable String fileId) {
    ...
    @PostMapping("/resource/{fileId}/report")
    ...
    @GetMapping("/resource/saved/lectures")
    ApiResponse<PageResponse<SavedResource>> savedLectures(
    ...
    @GetMapping("/resource/saved/textbooks")
    ApiResponse<PageResponse<SavedResource>> savedTextbooks(
            @RequestParam(defaultValue = "1") int page,
            @RequestParam(defaultValue = "10") int size) {
        return ApiResponse.<PageResponse<SavedResource>>builder()
